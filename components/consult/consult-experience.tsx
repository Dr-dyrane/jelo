...
function formatPrice(product: ConsultProduct) { if (!product.price) return 'Live price'; return new Intl.NumberFormat(product.price.currency === 'NGN' ? 'en-NG' : 'en-US', { style: 'currency', currency: product.price.currency, maximumFractionDigits: product.price.currency === 'NGN' ? 0 : 2 }).format(product.price.amount); }
