  ...
  return (
    <section className={styles.shelf}>
      <Reveal className={styles.sectionHeading}>
        ...
        <Link className="text-link" href={railHref}>
    ...
    <section className={styles.stories} aria-label="Care stories">
      <article>
        ...
        <div className={styles.storyCopy}>
          ...
          <Link href="/concerns">
            Explore concerns <ArrowRight size={15} aria-hidden="true" />
          </Link>
        </div>
      </article>
      <article>
        ...
        <div className={styles.storyCopy}>
          ...
          <Link href="/concerns/dandruff-itchy-scalp">
            Read the scalp guide <ArrowRight size={15} aria-hidden="true" />
          </Link>
        </div>
      </article>
      <article>
        ...
        <div className={styles.storyCopy}>
          ...
          <Link href="/consult">
            Ask JeloCare <ArrowRight size={15} aria-hidden="true" />
          </Link>
        </div>
      </article>
    </section>
