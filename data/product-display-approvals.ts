...
type ApprovalInput = Pick<
  DisplayApproval["identityReview"],
  "brand" | "name" | "size" | "sourceUrl"
> & {
  contentHash: string;
  reviewedAt: string;
};
...
export const productDisplayApprovals = {
  "skin-by-zaron-vitamin-c-body-lotion-500ml": approval({
    ...
    size: "500 ml",
    sourceUrl:
      "https://i0.wp.com/buybetter.ng/wp-content/uploads/2024/09/vecg0cn6.png?fit=1200%2C1200&quality=80&ssl=1",
    contentHash:
      "fe43be4dfea2e70206903a674003a9ebcd4ffc969f3836993433990b1f230567",
  ...
  "some-by-mi-aha-bha-pha-miracle-toner": approval({
    ...
    contentHash:
      "d392e6f06ab8c2718a3ab43cb83cc37237a555b5ced2c6e7dfcf553b4e3bfcaf",
  ...
  "anua-niacinamide-10-txa-4-serum": approval({
    ...
    size: "30 ml",
    sourceUrl:
      "https://anua.com/cdn/shop/files/anua-global-ampoule-serum-niacinamide-10-txa-4-serum-for-brightening-and-dark-spots-1239193722.jpg?v=1779177130&width=2000",
    contentHash:
      "225e3a52fd9b2f4a092a3c8b970e608d13246e0e2187677fb71b1f2350e4b669",
  ...
  "lush-hair-mentholated-conditioner": approval({
    ...
    contentHash:
      "e746810397f9caeb94a5efa9204b564f2175216c4f84419bfb35d4cd757db560",
  ...
  "b-lab-matcha-hydrating-real-sunscreen": approval({
    ...
    contentHash:
      "73122802ca451c6cedb4c5ac3e1d184be9098bc9819abf3307c07fec682d4d8f",
  ...
  "disaar-argan-oil-body-oil-gel": approval({
    ...
    contentHash:
      "62f489d01351dd2ad85d90570aa343e0767fe8b01376c14d09aabba1990b7a8e",
  ...
  "the-ordinary-azelaic-acid-suspension-10": approval({
    ...
    size: "30 ml",
    sourceUrl:
      "https://theordinary.com/dw/image/v2/BFKJ_PRD/on/demandware.static/-/Sites-deciem-master/default/dw711cec9a/Images/products/The%20Ordinary/rdn-azelaic-acid-suspension-10pct-30ml.png?sw=1200&sh=1200&sm=fit",
    contentHash:
  ...
  "panoxyl-acne-foaming-wash-10-benzoyl-peroxide": approval({
    ...
    size: "156 g",
    sourceUrl:
      "https://panoxyl.com/wp-content/uploads/2023/06/PanOxyl_Acne-Foaming-Wash_Front_5.5oz-Tube_SILO_wide.webp",
    contentHash:
      "9754b77a86ad86d492e921c2c9c36842a668600c417e9af98125de57e9980ed1",
    reviewedAt: "2026-07-22T12:34:11.000Z",
  }),
  "face-facts-wonder-cream-fragrance-free": approval({
    ...
    size: "50 ml",
    sourceUrl:
      "https://facefacts.me/cdn/shop/files/39163_150_fr1.png?v=1759159571",
    contentHash:
      "c4feb7aa3ed19996e9be53147a7a550b697ee65ee5b5d8b58fed1936f5a347b9",
    reviewedAt: "2026-07-22T12:34:11.000Z",
  }),
  "face-facts-bright-clear-face-cream": approval({
    ...
    contentHash:
      "5c120eb9d657eca8c46a594f9ef22e7762e8e08109a667d86b703032262752b3",
  ...
  "kuza-indian-hemp-hair-scalp-treatment": approval({
    ...
    contentHash:
      "cdc1398f2086e51a3cc4d19877aa1af4bb2ed752655da6e36ec9e6f59581524c",
...
export function isProductDisplayApproved(
  ...
  const record =
    productDisplayApprovals[
      product.slug as keyof typeof productDisplayApprovals
    ];
  return Boolean(
    record &&
    asset &&
