...
export const nigeriaRetailers: RetailerReference[] = [
  ...
  },
  {
    ...
    identityEvidence: {
      ...
      sourceUrl: 'https://dunescenter.com/product/cerave-facial-moisturising-lotion-pm-52ml/',
  ...
  },
  {
    ...
    identityEvidence: {
      ...
      sourceUrl: 'https://www.caretobeauty.com/ng/cerave-facial-moisturising-lotion-52ml/',
      basis: 'self-published-contact',
      scope: 'self-published',
    },
    searchUrl: query => `https://www.caretobeauty.com/ng/catalogsearch/result/?q=${encodeURIComponent(query)}`,
  ...
  },
  {
    ...
    identityEvidence: {
      ...
      sourceUrl: 'https://nihetbeauty.com/product/prequel-gleanser-glycolic-acid-cleanser-400ml/',
      basis: 'self-published-contact',
      scope: 'self-published',
    },
  ...
  },
  {
    ...
    identityEvidence: {
      ...
      sourceUrl: 'https://essentialshub.com/product/prequel-gleanser-glycolic-acid-cleanser/',
      basis: 'self-published-contact',
      scope: 'self-published',
    },
  ...
  },
  {
    ...
    identityEvidence: {
      ...
      sourceUrl: 'https://tosnigeria.com/shop/naturium-the-perfector-salicylic-acid-skin-smoothing-body-wash-16-9-fl-oz-500ml/',
      basis: 'self-published-contact',
      scope: 'self-published',
    },
  ...
  },
  {
    ...
    identityEvidence: {
      ...
      sourceUrl: 'https://myskinhubng.com/products/medik8-crystal-retinal-6/3176365',
      basis: 'self-published-contact',
      scope: 'self-published',
    },
    searchUrl: query => `https://myskinhubng.com/search?q=${encodeURIComponent(query)}`,
  ...
  },
  {
    ...
    identityEvidence: {
      ...
      sourceUrl: 'https://skincareplug-ng.com/products/medik8-crystal-retinal-3',
      basis: 'self-published-contact',
      scope: 'self-published',
    },
    searchUrl: query => `https://skincareplug-ng.com/search?q=${encodeURIComponent(query)}`,
    note: 'Nigeria skincare retailer with a direct Shopify catalogue and Naira pricing; links remain advisory only.',
  },
  {
    ...
    identityEvidence: {
      ...
      sourceUrl: 'https://thebeautyprismng.com/shop/the-perfector-salicylic-acid-body-wash/',
      basis: 'self-published-contact',
      scope: 'self-published',
    },
