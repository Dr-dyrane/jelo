...
export const nigeriaRetailers: RetailerReference[] = [
  ...
  {
    name: "Shoppaton Store",
    homepage: "https://shoppatonstore.com/",
    market: "NG",
    kind: "retailer",
    trust: 78,
    reviewStatus: "directory-listed",
    contentUse: "link-only",
    identityEvidence: {
      observedAt: "2026-08-30T02:56:10Z",
      sourceUrl:
        "https://shoppatonstore.com/store/product/cerave-pm-facial-moisturising-lotion-52ml/",
      basis: "self-published-contact",
      scope: "self-published",
    },
    searchUrl: wordpressSearch("https://shoppatonstore.com/"),
    note: "Nigeria retailer with a direct product catalogue, Naira pricing and visible inventory; links remain advisory only.",
  },
  {
    name: "Buy Skincare in Abuja",
    homepage: "https://buyskincareinabuja.com/",
    market: "NG",
    kind: "retailer",
    trust: 78,
    reviewStatus: "directory-listed",
    ...
    searchUrl: wordpressSearch("https://buyskincareinabuja.com/"),
    note: "Abuja skincare retailer with direct Naira listings and visible stock; links remain advisory only.",
  },
  {
    name: "The Skin Hookup",
    homepage: "https://www.theskinhookupng.com/",
    market: "NG",
    kind: "retailer",
    trust: 78,
    reviewStatus: "directory-listed",
    ...
    searchUrl: wordpressSearch("https://www.theskinhookupng.com/"),
