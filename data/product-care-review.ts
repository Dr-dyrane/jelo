export type ProductCareState =
  "supportive_eligible" | "pharmacist_review" | "insufficient_data";
...
export const reviewedProductCareManifest = {
  ...
  "anua-niacinamide-10-txa-4-serum": {
    ...
    approvedUses: [
      {
        id: "tone-support-review",
        label: "Tone-support review",
        concernIds: ["hyperpigmentation", "dark spots"],
        concernSlugs: ["dark-spots"],
      },
    ],
    evidenceSourceUrls: [
      "https://anua.com/products/niacinamide-10-txa-4-serum-2",
    ],
    reviewedAt,
  },
  ...
  "the-ordinary-azelaic-acid-suspension-10": {
    ...
    approvedUses: [
      {
        id: "azelaic-acid-review",
        label: "Azelaic-acid review",
        concernIds: ["acne", "hyperpigmentation", "dark spots", "redness"],
  ...
  "nizoral-ad-ketoconazole-shampoo": {
    ...
    approvedUses: [
      {
        id: "antidandruff-shampoo-review",
        label: "Medicated dandruff-shampoo review",
        concernIds: ["dandruff", "itch", "flaking", "seborrheic dermatitis"],
        concernSlugs: ["dandruff-itchy-scalp"],
      },
    ],
    evidenceSourceUrls: ["https://nizoral.com/"],
    reviewedAt,
  },
...
export const publishedProductCareManifest = {
  ...
  "naturium-kp-body-scrub-mask-8oz": {
    ...
    careState: "insufficient_data",
    approvedUses: [],
    evidenceSourceUrls: ["https://naturium.com/products/kp-body-scrub-mask"],
    reviewedAt: "2026-08-07",
  },
  ...
  "cerave-blemish-control-cleanser": {
    ...
    approvedUses: [
      {
        id: "blemish-cleansing-review",
        label: "Blemish-cleansing review",
        concernIds: ["acne", "blackheads", "whiteheads"],
        concernSlugs: ["acne-breakouts"],
      },
    ],
    evidenceSourceUrls: [
      "https://africa.cerave.com/en/our-products/cleansers/blemish-control-cleanser",
    ],
    reviewedAt: "2026-08-07",
  },
  "cerave-foaming-facial-cleanser": {
    ...
    approvedUses: [
      {
        id: "normal-oily-cleansing",
        label: "Cleansing for normal or oily skin",
        concernIds: ["oiliness"],
        concernSlugs: ["oily-congested-skin"],
    ...
    evidenceSourceUrls: [
      "https://africa.cerave.com/en/our-products/cleansers/foaming-cleanser",
    ],
    reviewedAt: "2026-08-07",
  },
  ...
  "cosrx-advanced-snail-96-mucin-power-essence": {
    ...
    approvedUses: [
      {
        id: "hydration-conditioning",
        label: "Hydration and skin conditioning",
        concernIds: ["dryness", "dehydration"],
        concernSlugs: ["dry-dehydrated-skin"],
      },
    ],
    evidenceSourceUrls: [
  ...
  "aveeno-daily-moisturizing-body-oil-mist-200ml": {
    productSlug: "aveeno-daily-moisturizing-body-oil-mist-200ml",
    careState: "insufficient_data",
    approvedUses: [],
    evidenceSourceUrls: [
      "https://www.aveeno.com/products/daily-moisturizing-body-oil-mist-with-oat-oil",
      "https://www.aad.org/public/everyday-care/skin-care-basics/dry/dermatologists-tips-relieve-dry-skin",
    ],
    reviewedAt: "2026-08-09",
  },
  "eos-coconut-waters-body-wash-473ml": {
    productSlug: "eos-coconut-waters-body-wash-473ml",
    careState: "insufficient_data",
    approvedUses: [],
    evidenceSourceUrls: [
      "https://evolutionofsmooth.com/products/coconut-waters-body-wash",
      "https://www.aad.org/public/everyday-care/skin-care-basics/care/face-washing-101",
    ],
    reviewedAt: "2026-08-09",
  },
  "eos-vanilla-cashmere-body-wash-473ml": {
    productSlug: "eos-vanilla-cashmere-body-wash-473ml",
    careState: "insufficient_data",
    approvedUses: [],
    evidenceSourceUrls: [
      "https://evolutionofsmooth.com/products/vanilla-cashmere-body-wash",
      "https://www.aad.org/public/everyday-care/skin-care-basics/care/face-washing-101",
    ],
    reviewedAt: "2026-08-09",
  },
  "eos-pink-champagne-body-wash-473ml": {
    productSlug: "eos-pink-champagne-body-wash-473ml",
    careState: "insufficient_data",
    approvedUses: [],
    evidenceSourceUrls: [
      "https://evolutionofsmooth.com/products/pink-champagne-body-wash",
      "https://www.aad.org/public/everyday-care/skin-care-basics/care/face-washing-101",
    ],
    reviewedAt: "2026-08-09",
  },
  ...
  "beauty-of-joseon-glow-serum-propolis-niacinamide-30ml": {
    productSlug: "beauty-of-joseon-glow-serum-propolis-niacinamide-30ml",
    careState: "insufficient_data",
    approvedUses: [],
    evidenceSourceUrls: [
...
export function matchingApprovedProductUses(
  ...
  const concernSlugs = new Set(
    input.concernSlugs.map((value) => value.trim().toLowerCase()),
  );

  return review.approvedUses.filter((use) =>
    Boolean(
      use.concernSlugs?.some((slug) => concernSlugs.has(slug.toLowerCase())),
    ),
  );
}
