...
export default function HomePage() {
  return <main>
    ...
    <section className="section-shell"><div className="section-heading"><div><p className="eyebrow">The collection</p><h2>Every formula<br/>earns its place.</h2></div><Link className="text-link" href="/products">View all →</Link></div><ProductRail products={products}/></section>
