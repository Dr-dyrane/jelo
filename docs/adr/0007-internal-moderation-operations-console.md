...
- **Market Finder extension (bounded Trade Fair pilot shipped; renewal release
  candidate):** migrations `0053`–`0055` provide the production physical-market,
  ...
  automatic physical observation.
