...
Updated: 2026-08-13
Status: Shelf, Routine, bounded private requests, complete Explore, member-Product OTP, global report helper, deterministic authenticated Ask, and opt-in order-service notifications ship. Protected activation, account-keyed Ask limiting, request operating closure, and production evidence remain.
