...
Updated: 2026-08-13
Status: Shelf, Routine, bounded private requests, complete Explore, member-Product OTP, global report helper, deterministic authenticated Ask with dual network/account abuse protection, and opt-in order-service notifications ship. Protected activation, request operating closure, and production evidence remain.
