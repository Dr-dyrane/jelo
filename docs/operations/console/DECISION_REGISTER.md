...
| [ADR 0016](../../adr/0016-retailer-scoped-assisted-procurement.md)                  | Retailer-scoped assisted procurement               | Procurement is a gated Triage workflow: manual quotes come first, customer-approved exact products and costs govern transitions, and the append-only order record remains authoritative. |
