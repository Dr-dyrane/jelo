...
The authoritative 2026-07-23T10:43Z pipeline state is 23 reviewed research records, 32 live products, 977 frozen private bulk candidates, 1,000 screened Nigerian retailer leads, 17 deliberate per-SKU intake candidates, 17 canonical identity artifacts, 17 approval-ready candidates, 17 private publication dossiers and 17 explicit releases. The chronological release paragraph below retains its earlier count snapshot; `npm run catalogue:pipeline:status` is the source of truth for current totals.
