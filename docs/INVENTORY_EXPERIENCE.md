...
Current derived state is 23 reviewed research records, 15 display-approved public records, 977 frozen private bulk candidates, 1,000 screened Nigerian retailer leads, 8 deliberate per-SKU intake candidates, 8 canonical identity artifacts, 0 approval-ready intake candidates, 0 private publication dossiers and 0 explicit public releases. Seven of the original 14-product dossier now pass the public image gate; the other seven remain in the reviewed catalogue while their exact packshots are improved. All eight intake candidates have passed identity and bounded care review and are now at Nigerian regulatory and exact-offer evidence. The two exact Aqua Rich 500 ml identities have narrow daily-moisturising reviews; sunscreen and treatment claims remain excluded, and their Nigerian retailer pages remain research observations until those pages expose the exact manufacturer identity. The Hydrating Cleanser now has one brand-authorized Nigerian offer bound to the printed package EAN in the retailer gallery; official NAFDAC search did not establish a product-specific record, so it remains private. The `publicCatalogueCount` value inside the frozen legacy bulk metadata describes the retired count-first release target; neither that value nor the discovery-lead count is current public inventory or suitable UI copy.
