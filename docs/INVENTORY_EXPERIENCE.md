...
The authoritative 2026-07-23T10:02Z pipeline state is 23 reviewed research records, 31 live products, 977 frozen private bulk candidates, 1,000 screened Nigerian retailer leads, 16 deliberate per-SKU intake candidates, 16 canonical identity artifacts, 16 approval-ready candidates, 16 private publication dossiers and 16 explicit releases. The chronological release paragraph below retains its earlier count snapshot; `npm run catalogue:pipeline:status` is the source of truth for current totals.
