...
The authoritative 2026-07-23T12:22Z pipeline state is 23 reviewed research records, 33 live products, 977 frozen private bulk candidates, 1,000 screened Nigerian retailer leads, 18 deliberate per-SKU intake candidates, 18 canonical identity artifacts, 18 approval-ready candidates, 18 private publication dossiers and 18 explicit releases. The chronological release paragraph below retains its earlier count snapshot; `npm run catalogue:pipeline:status` is the source of truth for current totals.
