...
Current derived state is 23 reviewed research records, 11 display-approved public records, 977 frozen private bulk candidates, 1,000 screened Nigerian retailer leads, 6 deliberate per-SKU intake candidates, 6 canonical identity artifacts, and 0 approval-ready intake candidates. Six of the original 14-product dossier now pass the public image gate; the other eight remain in the reviewed catalogue while their exact packshots are improved. All six intake dossiers have passed identity and bounded care review and are now at Nigerian regulatory and exact-offer evidence. The `publicCatalogueCount` value inside the frozen legacy bulk metadata describes the retired count-first release target; neither that value nor the discovery-lead count is current public inventory or suitable UI copy.
