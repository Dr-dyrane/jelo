...
| Consult task and visit context | Active; `/root/consult_context_regression`; base `b034dcb0a38f47922c50d36271f6a5805949c2e6` | Public/shared consult experience, route composition, consult CSS, focused consult UI/context tests and directly governing Ask Jelo docs                                                                                                                                                                                                                                                                                                                                                                     | Persistent raw transcript storage, database schema, clinical/product authority, Gateway model policy, push/deploy |
| Public first-task visibility   | Active; `/root/public_task_visibility`; base `b034dcb0a38f47922c50d36271f6a5805949c2e6`     | Mobile product-detail, basket and bundle opening composition in their route-owned components/styles and focused UI tests                                                                                                                                                                                                                                                                                                                                                                                    | Commerce/domain logic, prices/offers, checkout/order, shared globals/tokens, push/deploy                          |
