...
| X reply desk               | Active; `/root`; base `afd643af78d8ab053943738c13d4af56695114cc`                           | `public/campaigns/social/2026-08-25-x-reply-desk-v1/**`; read-only X scouting, reply drafts, and media/rights plans                                                                                                                                                                                                                                                                                                                                                                                         | External publication, shared campaign engine, catalogue mutations, push/deploy      |
