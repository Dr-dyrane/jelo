...
function candidateScopedManufacturerCareSource(
  candidate: CatalogueIntakeCandidate,
  evidenceUrl: string | undefined,
) {
...
function officialIdentityEvidenceValid(
  candidate: CatalogueIntakeCandidate,
  asOf: number,
) {
...
function generationRecordContent(
...
function generationRecordValid(
  candidate: CatalogueIntakeCandidate,
  asOf: number,
) {
...
function reviewedOfferTitleAlias(
  candidate: CatalogueIntakeCandidate,
...
function retainedOfficialManufacturerBrandAliases(
  candidate: CatalogueIntakeCandidate,
) {
