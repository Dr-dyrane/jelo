...
test('the checked-in publication manifest contains the verified neutral reference dossiers', () => {
  ...
  assert.equal(result.dossiers[128].candidateId, 'cerave-acne-foaming-cream-wash-10-150ml');
  ...
  assert.equal(result.dossiers[127].candidateId, 'cerave-sa-smoothing-cleanser-473ml');
  ...
  assert.equal(result.dossiers[123].candidateId, 'facefacts-ceramide-hydrating-gentle-cleanser-400ml');
  assert.equal(result.dossiers[123].nigeria.marketRoute, 'tier-a');
  assert.deepEqual(result.dossiers[123].nigeria.exactOffers.map(offer => offer.priceNgn), [6_950, 7_200, 7_300]);
...
test('the checked-in release manifest explicitly publishes the verified neutral references', () => {
  ...
  assert.equal(report.products[128].slug, 'cerave-acne-foaming-cream-wash-10-150ml');
  ...
  assert.equal(report.products[128].offers[0].priceNgn, 23_850);
  ...
  assert.equal(report.products[127].slug, 'cerave-sa-smoothing-cleanser-473ml');
  ...
  assert.equal(report.products[127].offers[0].priceNgn, 20_900);
  assert.equal(report.products[127].offers[0].available, true);
  assert.equal(report.products[127].offers[1].retailer, '24Eleven');
  assert.equal(report.products[127].offers[1].priceNgn, 23_800);
  ...
  assert.equal(report.products[123].slug, 'facefacts-ceramide-hydrating-gentle-cleanser-400ml');
  ...
  assert.equal(report.products[123].offers[0].priceNgn, 6_950);
  assert.equal(report.products[123].offers[1].retailer, 'Teeka4');
  assert.equal(report.products[123].offers[1].priceNgn, 7_200);
  assert.equal(report.products[123].offers[2].retailer, '24Eleven');
  assert.equal(report.products[123].offers[2].priceNgn, 7_300);
