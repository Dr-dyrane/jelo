...
test('the checked-in publication manifest contains the verified neutral reference dossiers', () => {
  ...
  assert.equal(result.dossiers[127].candidateId, 'balance-salicylic-acid-zinc-clarifying-toner-200ml');
  ...
  assert.equal(result.dossiers[123].candidateId, 'cerave-acne-foaming-cream-wash-10-150ml');
  ...
  assert.equal(result.dossiers[13].candidateId, 'de-la-cruz-acne-treatment-10-sulfur-73-7g');
  assert.equal(result.dossiers[13].nigeria.exactOffers.length, 2);
  assert.equal(result.dossiers[14].candidateId, 'olay-super-serum-body-wash-normal-skin-547ml');
  assert.equal(result.dossiers[14].nigeria.marketRoute, 'tier-a');
  assert.deepEqual(result.dossiers[14].nigeria.exactOffers.map(offer => offer.priceNgn), [20_000, 21_200]);
  assert.equal(result.dossiers[14].rights.generationRecord?.outputSha256, result.dossiers[14].finalImage.sha256);
  assert.equal(result.dossiers[15].candidateId, 'dove-calming-moisture-body-wash-547ml');
  assert.equal(result.dossiers[15].nigeria.marketRoute, 'tier-a');
  assert.deepEqual(result.dossiers[15].nigeria.exactOffers.map(offer => offer.priceNgn), [22_600, 17_800]);
  assert.equal(result.dossiers[15].rights.generationRecord?.outputSha256, result.dossiers[15].finalImage.sha256);
  assert.equal(result.dossiers[122].candidateId, 'cerave-sa-smoothing-cleanser-473ml');
  ...
  assert.equal(result.dossiers[128].candidateId, 'garnier-vitamin-c-brightening-day-cream-50ml');
  ...
  assert.equal(result.dossiers[11].candidateId, 'facefacts-ceramide-oil-control-foaming-cleanser-400ml');
  assert.equal(result.dossiers[11].nigeria.marketRoute, 'tier-a');
  assert.deepEqual(result.dossiers[11].nigeria.exactOffers.map(offer => offer.priceNgn), [6_880, 7_300]);
  assert.equal(result.dossiers[11].rights.generationRecord?.outputSha256, result.dossiers[11].finalImage.sha256);
  assert.equal(result.dossiers[118].candidateId, 'facefacts-ceramide-hydrating-gentle-cleanser-400ml');
  assert.equal(result.dossiers[118].nigeria.marketRoute, 'tier-a');
  assert.deepEqual(result.dossiers[118].nigeria.exactOffers.map(offer => offer.priceNgn), [6_950, 7_200, 7_300]);
  assert.equal(result.dossiers[118].rights.generationRecord?.outputSha256, result.dossiers[118].finalImage.sha256);
  assert.equal(result.dossiers[12].candidateId, 'facefacts-ceramide-foaming-cleanser-400ml');
  assert.equal(result.dossiers[12].nigeria.marketRoute, 'tier-a');
  assert.deepEqual(result.dossiers[12].nigeria.exactOffers.map(offer => offer.priceNgn), [6_450, 6_800]);
  assert.equal(result.dossiers[12].rights.generationRecord?.outputSha256, result.dossiers[12].finalImage.sha256);
  assert.equal(result.dossiers[18].candidateId, 'facefacts-vitamin-c-body-lotion-400ml');
  assert.equal(result.dossiers[18].nigeria.marketRoute, 'tier-a');
  assert.deepEqual(result.dossiers[18].nigeria.exactOffers.map(offer => offer.priceNgn), [6_095, 8_000]);
...
test('the checked-in release manifest explicitly publishes the verified neutral references', () => {
  ...
  assert.equal(report.products[127].slug, 'balance-salicylic-acid-zinc-clarifying-toner-200ml');
  ...
  assert.equal(report.products[127].offers[1].priceNgn, 9_200);
  assert.equal(report.products[127].offers[1].available, true);
  assert.equal(report.products[123].slug, 'cerave-acne-foaming-cream-wash-10-150ml');
  ...
  assert.equal(report.products[11].slug, 'facefacts-ceramide-oil-control-foaming-cleanser-400ml');
  ...
  assert.equal(report.products[11].offers[0].priceNgn, 6_880);
  assert.equal(report.products[11].offers[0].available, true);
  assert.equal(report.products[11].offers[1].retailer, '24Eleven');
  assert.equal(report.products[11].offers[1].priceNgn, 7_300);
  assert.equal(report.products[11].offers[1].available, true);
  assert.equal(report.products[118].slug, 'facefacts-ceramide-hydrating-gentle-cleanser-400ml');
  ...
  assert.equal(report.products[118].offers[0].priceNgn, 6_950);
  assert.equal(report.products[118].offers[1].retailer, 'Teeka4');
  assert.equal(report.products[118].offers[1].priceNgn, 7_200);
  assert.equal(report.products[118].offers[2].retailer, '24Eleven');
  assert.equal(report.products[118].offers[2].priceNgn, 7_300);
  assert.equal(report.products[12].slug, 'facefacts-ceramide-foaming-cleanser-400ml');
  ...
  assert.equal(report.products[12].offers[0].priceNgn, 6_450);
  assert.equal(report.products[12].offers[0].available, true);
  assert.equal(report.products[12].offers[1].retailer, '24Eleven');
  assert.equal(report.products[12].offers[1].priceNgn, 6_800);
  assert.equal(report.products[12].offers[1].available, true);
  assert.equal(report.products[13].slug, 'de-la-cruz-acne-treatment-10-sulfur-73-7g');
  ...
  assert.equal(report.products[13].offers[1].priceNgn, 17_738);
  assert.equal(report.products[13].offers[1].available, false);
  assert.equal(report.products[14].slug, 'olay-super-serum-body-wash-normal-skin-547ml');
  ...
  assert.equal(report.products[14].offers[0].priceNgn, 20_000);
  assert.equal(report.products[14].offers[0].available, true);
  assert.equal(report.products[14].offers[1].retailer, 'Perona Beauty');
  assert.equal(report.products[14].offers[1].priceNgn, 21_200);
  assert.equal(report.products[14].offers[1].available, true);
  assert.equal(report.products[15].slug, 'dove-calming-moisture-body-wash-547ml');
  ...
  assert.equal(report.products[15].offers[0].priceNgn, 22_600);
  assert.equal(report.products[15].offers[0].available, true);
  assert.equal(report.products[15].offers[1].retailer, 'Teeka4');
  assert.equal(report.products[15].offers[1].priceNgn, 17_800);
  assert.equal(report.products[15].offers[1].available, false);
  assert.equal(report.products[18].slug, 'facefacts-vitamin-c-body-lotion-400ml');
  assert.equal(report.products[18].category, 'Body');
  assert.equal(report.products[18].step, 'Moisturize');
  assert.equal(report.products[18].offers[0].retailer, 'BuyBetter');
  assert.equal(report.products[18].offers[0].priceNgn, 6_095);
  assert.equal(report.products[18].offers[0].available, true);
  assert.equal(report.products[18].offers[1].retailer, 'Allure Beauty');
  assert.equal(report.products[18].offers[1].priceNgn, 8_000);
  assert.equal(report.products[18].offers[1].available, true);
});
