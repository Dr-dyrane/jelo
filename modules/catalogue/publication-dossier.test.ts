...
test('the checked-in publication manifest contains the verified neutral reference dossiers', () => {
  ...
  assert.equal(result.dossiers[126].candidateId, 'cerave-acne-foaming-cream-wash-10-150ml');
  ...
  assert.equal(result.dossiers[125].candidateId, 'cerave-sa-smoothing-cleanser-473ml');
  ...
  assert.equal(result.dossiers[121].candidateId, 'facefacts-ceramide-hydrating-gentle-cleanser-400ml');
  assert.equal(result.dossiers[121].nigeria.marketRoute, 'tier-a');
  assert.deepEqual(result.dossiers[121].nigeria.exactOffers.map(offer => offer.priceNgn), [6_950, 7_200, 7_300]);
...
test('the checked-in release manifest explicitly publishes the verified neutral references', () => {
  ...
  assert.equal(report.products[126].slug, 'cerave-acne-foaming-cream-wash-10-150ml');
  ...
  assert.equal(report.products[126].offers[0].priceNgn, 23_850);
  assert.equal(report.products[126].offers[0].available, true);
  assert.equal(report.products[126].offers[1].retailer, 'Teeka4');
  assert.equal(report.products[126].offers[1].priceNgn, 24_500);
  assert.equal(report.products[126].offers[1].available, true);
  assert.equal(report.products[125].slug, 'cerave-sa-smoothing-cleanser-473ml');
  ...
  assert.equal(report.products[121].slug, 'facefacts-ceramide-hydrating-gentle-cleanser-400ml');
  ...
  assert.equal(report.products[121].offers[0].priceNgn, 6_950);
  assert.equal(report.products[121].offers[1].retailer, 'Teeka4');
  assert.equal(report.products[121].offers[1].priceNgn, 7_200);
  assert.equal(report.products[121].offers[2].retailer, '24Eleven');
  assert.equal(report.products[121].offers[2].priceNgn, 7_300);
