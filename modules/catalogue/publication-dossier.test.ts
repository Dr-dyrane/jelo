...
test('the checked-in publication manifest contains the verified neutral reference dossiers', () => {
  ...
  assert.equal(result.dossiers[17].candidateId, 'de-la-cruz-acne-treatment-10-sulfur-73-7g');
  assert.equal(result.dossiers[17].nigeria.exactOffers.length, 2);
  assert.equal(result.dossiers[18].candidateId, 'olay-super-serum-body-wash-normal-skin-547ml');
  assert.equal(result.dossiers[18].nigeria.marketRoute, 'tier-a');
  assert.deepEqual(result.dossiers[18].nigeria.exactOffers.map(offer => offer.priceNgn), [20_000, 21_200]);
  assert.equal(result.dossiers[18].rights.generationRecord?.outputSha256, result.dossiers[18].finalImage.sha256);
  assert.equal(result.dossiers[19].candidateId, 'dove-calming-moisture-body-wash-547ml');
  assert.equal(result.dossiers[19].nigeria.marketRoute, 'tier-a');
  assert.deepEqual(result.dossiers[19].nigeria.exactOffers.map(offer => offer.priceNgn), [22_600, 17_800]);
  ...
  assert.equal(result.dossiers[9].candidateId, 'garnier-vitamin-c-brightening-day-cream-50ml');
  assert.equal(result.dossiers[9].nigeria.marketRoute, 'tier-a');
  assert.equal(result.dossiers[9].nigeria.exactOffers.length, 2);
  ...
  assert.equal(result.dossiers[10].candidateId, 'aqua-rich-ceramide-body-lotion-500ml');
  assert.equal(result.dossiers[10].identity.name, 'Hydrate + Protect Body Lotion');
  assert.equal(result.dossiers[10].nigeria.marketRoute, 'tier-a');
  assert.deepEqual(result.dossiers[10].nigeria.exactOffers.map(offer => offer.priceNgn), [12_800, 13_000]);
  ...
  assert.equal(result.dossiers[11].candidateId, 'aqua-rich-turmeric-vitamin-c-body-lotion-500ml');
  assert.equal(result.dossiers[11].nigeria.marketRoute, 'tier-a');
  assert.deepEqual(result.dossiers[11].nigeria.exactOffers.map(offer => offer.priceNgn), [10_750, 12_000]);
  ...
  assert.equal(result.dossiers[12].candidateId, 'balance-niacinamide-blemish-recovery-serum-30ml');
  ...
  assert.equal(result.dossiers[125].candidateId, 'facefacts-ceramide-hydrating-gentle-cleanser-400ml');
  assert.equal(result.dossiers[125].nigeria.marketRoute, 'tier-a');
  assert.deepEqual(result.dossiers[125].nigeria.exactOffers.map(offer => offer.priceNgn), [6_950, 7_200, 7_300]);
  ...
  assert.equal(result.dossiers[22].candidateId, 'facefacts-vitamin-c-body-lotion-400ml');
  assert.equal(result.dossiers[22].nigeria.marketRoute, 'tier-a');
  assert.deepEqual(result.dossiers[22].nigeria.exactOffers.map(offer => offer.priceNgn), [6_095, 8_000]);
  assert.equal(result.dossiers[22].rights.generationRecord?.outputSha256, result.dossiers[22].finalImage.sha256);
});
...
test('the checked-in release manifest explicitly publishes the verified neutral references', () => {
  ...
  assert.equal(report.products[8].slug, 'cerave-sa-smoothing-cleanser-473ml');
  assert.equal(report.products[8].category, 'Face');
  assert.equal(report.products[8].step, 'Cleanse');
  assert.equal(report.products[8].offers[0].retailer, 'Teeka4');
  assert.equal(report.products[8].offers[0].priceNgn, 20_900);
  assert.equal(report.products[8].offers[0].available, true);
  assert.equal(report.products[8].offers[1].retailer, '24Eleven');
  assert.equal(report.products[8].offers[1].priceNgn, 23_800);
  assert.equal(report.products[8].offers[1].available, true);
  assert.equal(report.products[9].slug, 'garnier-vitamin-c-brightening-day-cream-50ml');
  ...
  assert.equal(report.products[9].offers[0].priceNgn, 12_728);
  assert.equal(report.products[9].offers[0].available, true);
  assert.equal(report.products[9].offers[1].retailer, 'Teeka4');
  assert.equal(report.products[9].offers[1].priceNgn, 11_833);
  assert.equal(report.products[9].offers[1].available, true);
  assert.equal(report.products[10].slug, 'aqua-rich-ceramide-body-lotion-500ml');
  ...
  assert.equal(report.products[10].offers[0].priceNgn, 12_800);
  assert.equal(report.products[10].offers[0].available, true);
  assert.equal(report.products[10].offers[1].retailer, 'CSi Grocery');
  assert.equal(report.products[10].offers[1].priceNgn, 13_000);
  assert.equal(report.products[10].offers[1].available, true);
  assert.equal(report.products[11].slug, 'aqua-rich-turmeric-vitamin-c-body-lotion-500ml');
  assert.equal(report.products[11].category, 'Body');
  assert.equal(report.products[11].step, 'Moisturize');
  assert.equal(report.products[11].offers[0].retailer, 'BuyBetter');
  assert.equal(report.products[11].offers[0].priceNgn, 10_750);
  assert.equal(report.products[11].offers[0].available, true);
  assert.equal(report.products[11].offers[1].retailer, 'Kadimez Essentials');
  assert.equal(report.products[11].offers[1].priceNgn, 12_000);
  assert.equal(report.products[11].offers[1].available, true);
  assert.equal(report.products[12].slug, 'balance-niacinamide-blemish-recovery-serum-30ml');
  assert.equal(report.products[12].category, 'Face');
  assert.equal(report.products[12].step, 'Treat');
  assert.equal(checkedInReleaseManifest.releases[12].recommendationEligible, false);
  assert.equal(report.products[12].offers[0].retailer, 'BuyBetter');
  assert.equal(report.products[12].offers[0].priceNgn, 8_400);
  ...
  assert.equal(report.products[125].slug, 'facefacts-ceramide-hydrating-gentle-cleanser-400ml');
  ...
  assert.equal(report.products[125].offers[0].priceNgn, 6_950);
  assert.equal(report.products[125].offers[1].retailer, 'Teeka4');
  assert.equal(report.products[125].offers[1].priceNgn, 7_200);
  assert.equal(report.products[125].offers[2].retailer, '24Eleven');
  assert.equal(report.products[125].offers[2].priceNgn, 7_300);
  ...
  assert.equal(report.products[16].offers[0].priceNgn, 6_450);
  assert.equal(report.products[16].offers[0].available, true);
  assert.equal(report.products[16].offers[1].retailer, '24Eleven');
  assert.equal(report.products[16].offers[1].priceNgn, 6_800);
  assert.equal(report.products[16].offers[1].available, true);
  assert.equal(report.products[17].slug, 'de-la-cruz-acne-treatment-10-sulfur-73-7g');
  assert.equal(report.products[17].category, 'Face');
  assert.equal(report.products[17].step, 'Treat');
  assert.equal(report.products[17].offers[0].retailer, 'Beauty by Daz');
  assert.equal(report.products[17].offers[0].priceNgn, 12_500);
  assert.equal(report.products[17].offers[0].available, true);
  assert.equal(report.products[17].offers[1].retailer, 'BuyBetter');
  assert.equal(report.products[17].offers[1].priceNgn, 17_738);
  assert.equal(report.products[17].offers[1].available, false);
  assert.equal(report.products[18].slug, 'olay-super-serum-body-wash-normal-skin-547ml');
  ...
  assert.equal(report.products[18].offers[0].priceNgn, 20_000);
  assert.equal(report.products[18].offers[0].available, true);
  assert.equal(report.products[18].offers[1].retailer, 'Perona Beauty');
  assert.equal(report.products[18].offers[1].priceNgn, 21_200);
  assert.equal(report.products[18].offers[1].available, true);
  assert.equal(report.products[19].slug, 'dove-calming-moisture-body-wash-547ml');
  ...
  assert.equal(report.products[19].offers[0].priceNgn, 22_600);
  assert.equal(report.products[19].offers[0].available, true);
  assert.equal(report.products[19].offers[1].retailer, 'Teeka4');
  assert.equal(report.products[19].offers[1].priceNgn, 17_800);
  assert.equal(report.products[19].offers[1].available, false);
  assert.equal(report.products[22].slug, 'facefacts-vitamin-c-body-lotion-400ml');
  assert.equal(report.products[22].category, 'Body');
  assert.equal(report.products[22].step, 'Moisturize');
  assert.equal(report.products[22].offers[0].retailer, 'BuyBetter');
  assert.equal(report.products[22].offers[0].priceNgn, 6_095);
  assert.equal(report.products[22].offers[0].available, true);
  assert.equal(report.products[22].offers[1].retailer, 'Allure Beauty');
  assert.equal(report.products[22].offers[1].priceNgn, 8_000);
  assert.equal(report.products[22].offers[1].available, true);
});
