...
test('the checked-in publication manifest contains the verified neutral reference dossiers', () => {
  ...
  assert.equal(result.dossierCount, 47);
  ...
  assert.equal(result.dossiers[20].candidateId, 'dove-calming-moisture-body-wash-547ml');
  assert.equal(result.dossiers[20].nigeria.marketRoute, 'tier-a');
  assert.deepEqual(result.dossiers[20].nigeria.exactOffers.map(offer => offer.priceNgn), [22_600, 17_800]);
  ...
  assert.equal(result.dossiers[16].candidateId, 'facefacts-ceramide-hydrating-gentle-cleanser-400ml');
  assert.equal(result.dossiers[16].nigeria.marketRoute, 'tier-a');
  assert.deepEqual(result.dossiers[16].nigeria.exactOffers.map(offer => offer.priceNgn), [6_950, 7_200, 7_300]);
  assert.equal(result.dossiers[16].rights.generationRecord?.outputSha256, result.dossiers[16].finalImage.sha256);
  assert.equal(result.dossiers[17].candidateId, 'facefacts-ceramide-foaming-cleanser-400ml');
  assert.equal(result.dossiers[17].nigeria.marketRoute, 'tier-a');
  assert.deepEqual(result.dossiers[17].nigeria.exactOffers.map(offer => offer.priceNgn), [6_450, 6_800]);
  assert.equal(result.dossiers[17].rights.generationRecord?.outputSha256, result.dossiers[17].finalImage.sha256);
  assert.equal(result.dossiers[23].candidateId, 'facefacts-vitamin-c-body-lotion-400ml');
  assert.equal(result.dossiers[23].nigeria.marketRoute, 'tier-a');
  assert.deepEqual(result.dossiers[23].nigeria.exactOffers.map(offer => offer.priceNgn), [6_095, 8_000]);
  assert.equal(result.dossiers[23].rights.generationRecord?.outputSha256, result.dossiers[23].finalImage.sha256);
});
...
test('the checked-in release manifest explicitly publishes the verified neutral references', () => {
  ...
  assert.equal(report.releaseCount, 47);
  assert.deepEqual(
  ...
  assert.equal(report.products[16].slug, 'facefacts-ceramide-hydrating-gentle-cleanser-400ml');
  ...
  assert.equal(report.products[16].offers[0].priceNgn, 6_950);
  assert.equal(report.products[16].offers[1].retailer, 'Teeka4');
  assert.equal(report.products[16].offers[1].priceNgn, 7_200);
  assert.equal(report.products[16].offers[2].retailer, '24Eleven');
  assert.equal(report.products[16].offers[2].priceNgn, 7_300);
  assert.equal(report.products[17].slug, 'facefacts-ceramide-foaming-cleanser-400ml');
  ...
  assert.equal(report.products[17].offers[0].priceNgn, 6_450);
  assert.equal(report.products[17].offers[0].available, true);
  assert.equal(report.products[17].offers[1].retailer, '24Eleven');
  assert.equal(report.products[17].offers[1].priceNgn, 6_800);
  assert.equal(report.products[17].offers[1].available, true);
  assert.equal(report.products[18].slug, 'de-la-cruz-acne-treatment-10-sulfur-73-7g');
  assert.equal(report.products[18].category, 'Face');
  assert.equal(report.products[18].step, 'Treat');
  assert.equal(report.products[18].offers[0].retailer, 'Beauty by Daz');
  assert.equal(report.products[18].offers[0].priceNgn, 12_500);
  ...
  assert.equal(report.products[20].slug, 'dove-calming-moisture-body-wash-547ml');
  assert.equal(report.products[20].category, 'Body');
  assert.equal(report.products[20].step, 'Cleanse');
  assert.equal(report.products[20].offers[0].retailer, 'BuyBetter');
  assert.equal(report.products[20].offers[0].priceNgn, 22_600);
  assert.equal(report.products[20].offers[0].available, true);
  assert.equal(report.products[20].offers[1].retailer, 'Teeka4');
  assert.equal(report.products[20].offers[1].priceNgn, 17_800);
  assert.equal(report.products[20].offers[1].available, false);
  assert.equal(report.products[23].slug, 'facefacts-vitamin-c-body-lotion-400ml');
  assert.equal(report.products[23].category, 'Body');
  assert.equal(report.products[23].step, 'Moisturize');
  assert.equal(report.products[23].offers[0].retailer, 'BuyBetter');
  assert.equal(report.products[23].offers[0].priceNgn, 6_095);
  assert.equal(report.products[23].offers[0].available, true);
  assert.equal(report.products[23].offers[1].retailer, 'Allure Beauty');
  assert.equal(report.products[23].offers[1].priceNgn, 8_000);
  assert.equal(report.products[23].offers[1].available, true);
});
